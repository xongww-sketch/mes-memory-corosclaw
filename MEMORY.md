...
### 📈 不良率预测功能（2026-08-03 启动）

**发起人**：熊旺
**需求文档**：https://coros-teams.feishu.cn/docx/SoLXdNve7orhpsxqNRzcFNHQnnd
**现有工具**：不良品视图 lowcode（applicationId: 662b5ffd5ea62b764b96a3d7）

**关键决策**：
- 预测功能做到现有 tab5 上，不单独新增 tab
- 现有数据实线 + 预测数据虚线，虚线从实线末尾接续
- 算法在 n8n 中实现，不用 Python 单独部署
- 售出数 = 激活总数
- 支持多机型勾选预测 + 可选预测时间范围
- 熊旺选择**方案乙**（算法细节见需求文档）
- test 先行
